...
const HandleLikeScreen = () => {
  ...
  const createMatch = async () => {
    try {
      ...
      const response = await axios.post(`${env.IP}/create-match`, {
        currentUserId,
        selectedUserId,
      });
  ...
  const unlikeProfile = async () => {
    try {
      const currentUserId = route?.params?.userId; // Example currentUserId
      const unlikedUserId = route?.params?.selectedUserId; // Example unlikedUserId
      await axios.post(`${env.IP}/unlike-profile`, {
